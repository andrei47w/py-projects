...
def get_image_list():  # the list of paths to pictures
    # faces\ (1).png
    # image_list = [f'faces/ ({i}).png' for i in range(1, 101)]
    image_list = []
    image_list.extend([f'data/men{i}.jpg' for i in range(1, 50)])
    image_list.extend([f'data/women{i}.jpg' for i in range(1, 50)])
    image_list.extend([f'data/other{i}.jpg' for i in range(1, 10)])
