...
class UI():
    ...
    def __setup_param():
        ...
        Utils.GENERATION_COUNT = int(input('GENERATION_COUNT='))
    ...
    def run(self):
        ...
        while True:
            ...
            if option2 == 'a':
                ...
                startTime = time.time()
                newPath, _, _, solution_fitness = controller.start(Utils.POPULATION_SIZE,
                ...
                print("execution time:", endTime - startTime,
                      '\ncells discovered:', solution_fitness)
                path = newPath
                ...
                if option3 == 'a':
                    ...
                    startTime = time.time()
                    _, fitness_avg, fitness_max, solution_fitness = controller.start(Utils.POPULATION_SIZE,
                                                                                     Utils.INDIVIDUAL_SIZE,
                                                                                     Utils.RUNS,
                                                                                     Utils.BATTERY,
                                                                                     Utils.MUTATION_PROBABILITY,
                    ...
                    for i in range(10):
                        seed(i)
                        _, _, _, solution_fitness = controller.start(Utils.POPULATION_SIZE,
                                                                     Utils.INDIVIDUAL_SIZE,
                                                                     Utils.RUNS,
                                                                     Utils.BATTERY,
                                                                     Utils.MUTATION_PROBABILITY,
                                                                     Utils.CROSSOVER_PROBABILITY)
                        values.append(solution_fitness)
